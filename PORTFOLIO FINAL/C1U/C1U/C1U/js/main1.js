$(document).ready(function () {
    /* menu button click */
    $('#mmDrpdnMenuBtn, #btnHeaderSearch, #aoDrpdnMenuBtn, #sortDrpdnMenuDsktBtn, #sortDrpdnMenuMblBtn, #btnBlogSearch').on('click', function (event) {
    ...
    $('.page-backdrop, #mmList li, #mmCloseBtn, #mmSignInModalCloseBtn, #aoDrpdnMenu, #sortDrpdnMenuDskt, #sortDrpdnMenuMbl').on('click', function (event) {
    ...
    /* header search bar */
    $('#btnHeaderSearch, #btnBlogSearch').on('click', function (event) {
        $('#headerSearchBar, #blogSearchBar').toggleClass('show');
    ...
    /* SEARCH RESULT PAGE */
    /* filter search and sort below and equal to 767 */
    // if ($(window).width() <= 767) {
    // $('#sortDsktDropdownContent').contents().appendTo('#sortMblDropdownContent');
    // }
});